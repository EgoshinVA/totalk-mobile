...
import {useUpdateMeMutation} from "@/entities/session/api/sessionApi";
import {updateUser} from "@/entities/session/model/slice";
...
export const EditProfileScreen: React.FC = () => {
    ...
    const handleSave = async () => {
        ...
        try {
            const updated = await updateMe({name, surName}).unwrap();
